                ...
                for row in records.iterator():
                    ...
                    if permitted_decrypted_data:
                        ...
                        writer.writerow({
                            ...
                            'lab_culture_mgit_culture': labs_results[0]['lab_culture_mgit_culture'],
                            'lab_culture_lj_culture': labs_results[0]['lab_culture_lj_culture'],
                            'lab_lpa_mtbdrplus_isoniazid': labs_results[0]['lab_lpa_mtbdrplus_isoniazid'],
                            'lab_lpa_mtbdrplus_rifampin': labs_results[0]['lab_lpa_mtbdrplus_rifampin'],
                            'lab_lpa_mtbdrs_flouoroquinolones': labs_results[0]['lab_lpa_mtbdrs_flouoroquinolones'],
                            'lab_lpa_mtbdrs_kanamycin': labs_results[0]['lab_lpa_mtbdrs_kanamycin'],
                            'lab_lpa_mtbdrs_amikacin': labs_results[0]['lab_lpa_mtbdrs_amikacin'],
                            'lab_lpa_mtbdrs_capreomycin': labs_results[0]['lab_lpa_mtbdrs_capreomycin'],
                            'lab_lpa_mtbdrs_low_level_kanamycin': labs_results[0]['lab_lpa_mtbdrs_low_level_kanamycin'],
                            'lab_dst_isonazid': labs_results[0]['lab_dst_isonazid'],
                            'lab_dst_rifampin': labs_results[0]['lab_dst_rifampin'],
                            'lab_dst_ethambutol': labs_results[0]['lab_dst_ethambutol'],
                            'lab_dst_kanamycin': labs_results[0]['lab_dst_kanamycin'],
                            'lab_dst_ofloxacin': labs_results[0]['lab_dst_ofloxacin'],
                            'lab_dst_levofloxacinekanamycin': labs_results[0]['lab_dst_levofloxacinekanamycin'],
                            'lab_dst_moxifloxacinekanamycin': labs_results[0]['lab_dst_moxifloxacinekanamycin'],
                            'lab_dst_amikacinekanamycin': labs_results[0]['lab_dst_amikacinekanamycin'],
